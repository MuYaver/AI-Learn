    ...
    <div className="min-h-screen flex items-center justify-center bg-duo-surface px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-duo-text-secondary mt-2">Learn AI. Have fun. Level up.</p>
        </div>

        <div className="bg-white rounded-2xl shadow-lg p-8">
          <h2 className="text-2xl font-bold text-duo-text mb-6">Log in</h2>
          ...
          <p className="text-center text-sm text-duo-text-secondary mt-6">
            ...
            <Link href="/register" className="text-duo-green font-semibold hover:underline">
              Sign up
            </Link>
          </p>
        </div>
